path_name='/nfs/nas4/data-hanwei/data-hanwei/DATA/SmoothPerturbation/imagenet/new/inception/cw/0.01';
% path_name='/nfs/pyrex/raid6/hzhang/2017-nips/test/';
pic_list=dir(path_name);
p_n=size(pic_list);

save_path = sprintf('/nfs/nas4/data-hanwei/data-hanwei/DATA/SmoothPerturbation/imagenet/new/inception/cw/b0.01');
for i=3:p_n
