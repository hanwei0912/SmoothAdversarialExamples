...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
    ...
    X_train, Y_train, X_test, Y_test = data_mnist(train_start=train_start,
                                                  ...
                                                  test_end=test_end)
    #name='/nfs/pyrex/raid6/hzhang/number_one/data/mnist_BasicCnn_fgsm_ori_x.mat'
    #si.savemat(name,{'ori_x':X_test})
    # Use label smoothing
    ...
    #    layer = model.get_layer_names()
    #    fea=model.get_layer(x,layer[-3])
    #    fea_adv=model.get_layer(adv_x,layer[-3])
    #    # evaluate the data we need
    #    adv_image =fgsm.generate_np(X_test, **fgsm_params)
    #    pre_x=sess.run(preds,feed_dict={x:X_test,y:Y_test})      
    #    pre_adv=sess.run(preds_adv,feed_dict={x:X_test,y:Y_test})
