...
from attacks import CarliniWagnerL2
...
def main(_):
    ...
    for filenames, images, labels in load_images(FLAGS.input_dir, FLAGS.metadata_file_path, batch_shape):
        ...
        for i_y in range(FLAGS.batch_size):
            ...
            #     n_f = len(filenames)
            #     A = np.zeros((batch_shape,img_size,4))
            #     for i in range(n_f):
...
if __name__ == '__main__':
    ...
    path_save = '/nfs/pyrex/raid6/hzhang/2017-nips/cw/learning_rate/'+str(args.learning_rate)
