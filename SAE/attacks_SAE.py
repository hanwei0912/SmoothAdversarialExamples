...
class SmoothCarliniWagnerL2(Attack):
    ...
    def generate(self, x, **kwargs):
        ...
        """
        import tensorflow as tf
        from .attacks_tf_SAE import SmoothCarliniWagnerL2 as CLV2
...
class SmoothBasicIterativeMethod(Attack):
    ...
    def generate(self, x, Aa, **kwargs):
        ...
        for i in range(self.nb_iter):
            ...
            eta, div_z = tf.cond(tf.constant(self.flag,dtype=tf.bool),lambda:
                    f_sparse(eta,shape,Aa,div_z),
                    lambda:f_dense(eta,shape,Aa,div_z))
