...
from basic_cnn_models import ResNetModel
...
def main(_):
    ...
    for images, _, labels, filenames in load_images(FLAGS.input_dir, FLAGS.input_dir, FLAGS.metadata_file_path, batch_shape):
        ...
        b_i=b_i+20
        path_save="/nfs/nas4/data-hanwei/data-hanwei/DATA/SmoothPerturbation/imagenet/new/resnet/scw/real/"+str(FLAGS.learning_rate)+str(b_i/20)+".mat"
...
if __name__ == '__main__':
    ...
    tf.flags.DEFINE_string(
        'checkpoint_path', '/nfs/pyrex/raid6/hzhang/2017-nips/models/resnet_v2_50.ckpt', 'Path to checkpoint for inception network.')
    tf.flags.DEFINE_string(
        'input_dir', '/nfs/pyrex/raid6/hzhang/2017-nips/images', 'Input directory with images.')
    path_save ='/nfs/nas4/data-hanwei/data-hanwei/DATA/SmoothPerturbation/imagenet/new/resnet/scw/'+str(FLAGS.learning_rate)
